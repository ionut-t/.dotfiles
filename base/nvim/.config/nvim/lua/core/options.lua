...
vim.o.spell = false -- Enable spell checking (default: false)
vim.o.spelllang = 'en_gb' -- Set spell check language to British English (default: 'en')
...
-- vim.o.cursorlineopt = 'number' -- Only highlight the line number, not the entire line (default: 'both')
